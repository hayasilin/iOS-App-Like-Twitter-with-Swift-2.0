...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        Parse.setApplicationId("WsaQtVQwITBBfBgzuoQz51xuJfQa9SqszPjMnVr6", clientKey: "iK4H3YgAJomnGCEFBR0geEpSMPdYhtueCv2I1Nvo")
        ...
        pageController.currentPageIndicatorTintColor = UIColor.cyanColor()
        //end
